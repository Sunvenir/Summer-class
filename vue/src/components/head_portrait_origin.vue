  <template>
    ...
    <div style=" margin-top: 100px">
        ...
        <br>
        <h style="letter-spacing:3px;font-size:20px;font-family:楷体">点击图片上传或修改头像</h>
        <br>
        <h style="letter-spacing:2px;font-size: 15px;font-family: 楷体">仅支持上传JPG,PNG格式的文件,请注意上传文件格式</h>
    </div>
</div>
</template>
<script>
